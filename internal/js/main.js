...
// Points
const points = document.getElementById('counterScore')
...
startOverBtn.addEventListener('click', function() {
    counter = correct_points = questionId = 0
            ...
            if (val.type == 'boolean') {
                ...
                <div class='card-header'>${val.question}</div>
                    <div class='card-body d-flex justify-content-center'>
                        <a href='#question-${questionId}' data-answer='a' class='answer btn btn-outline-secondary mx-2'>${val.correct_answer}</a>
                        <a href='#question-${questionId}' data-answer='a-0' class='answer btn btn-outline-secondary mx-2'>${val.incorrect_answers}</a>
                    </div>
                ...
                <div class='card-header'>${val.question}</div>
                    <div class='card-body d-flex justify-content-between'>
                        <a href='#question-${questionId}' data-answer='a-0' class='answer btn btn-outline-secondary mx-2'>${val.incorrect_answers[0]}</a>
                        <a href='#question-${questionId}' data-answer='a' class='answer btn btn-outline-secondary mx-2'>${val.correct_answer}</a>
                        <a href='#question-${questionId}' data-answer='a-0' class='answer btn btn-outline-secondary mx-2'>${val.incorrect_answers[1]}</a>
                        <a href='#question-${questionId}' data-answer='a-0' class='answer btn btn-outline-secondary mx-2'>${val.incorrect_answers[2]}</a>
                    </div>
                    <div class='card-footer'>${val.category}</div>
                </div>`
            }
